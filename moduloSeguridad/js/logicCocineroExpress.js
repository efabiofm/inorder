...
function llenarTabla(){
    var peticion = $.ajax({
        url: "../moduloSeguridad/php/consultarColaPedidos.php",
        type: "post",
        data: {},
        dataType: 'json',
...
function crearListaEstados(seleccion){
    ...
    option3.text = 'En tránsito';
    //option4.text = 'Entregado';
...
function cambiarEstado(check){
    ...
    var i = rowIndex-1;
    var peticion = $.ajax({
        url: "../moduloSeguridad/php/modificarEstadoPlatoPedido.php",
        type: "post",
        data: {
...
function contarPlatos(){
    var peticion = $.ajax({
        url: "../moduloSeguridad/php/contarPlatosExpress.php",
        type: "post",
        data: {},
        dataType: 'json',
            ...
            for(var i=0; i<response.length;i++){
                switch(response[i]['estado']){
                    ...
                    case 'Listo para entregar':
                        ...
                        break;
                    case 'En tránsito':
                        document.querySelector('#txtTransito').value = response[i]['cantidad'];
                        break;
                    default:
                }
            }
